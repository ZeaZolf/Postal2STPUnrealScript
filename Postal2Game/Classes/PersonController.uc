...
const MAX_GET_DOWN_BLUFF=	10.0f;
...
const COMMENT_ON_FIRE_FREQ	=	0.25;
...
state DoPuking
{
	ignores BodyJuiceSquirtedOnMe, GettingDousedInGas, HearWhoAttackedMe, HearAboutKiller, 
		...
		CanHelpOthers, DangerPawnBump, Trigger, RocketIsAfterMe,  GetOutOfMyWay;
...
state PoisonedByAnthrax extends DoPukingBloody
{
	...
	function EndState()
	{
		...
		if(MyPawn.Health > 0)
		{
			...
			MyPawn.TakeDamage(takedamage, Attacker, MyPawn.Location, vect(0, 0, 1), class'P2Damage');
		}
	}
...
state PrepDeathCrawl
{
	ignores InterestIsAnnoyingUs, GetHitByDeadThing, BodyJuiceSquirtedOnMe, GettingDousedInGas, HearWhoAttackedMe, 
		...
		WingedByRifle, CanHelpOthers, DoWaitOnOtherGuy, TryToSendAway, Trigger, RocketIsAfterMe;
...
state RunOnFire extends RunToTarget
{
	ignores InterestIsAnnoyingUs, GetHitByDeadThing, BodyJuiceSquirtedOnMe, GettingDousedInGas, HearWhoAttackedMe, HearAboutKiller, 
		...
		HandleFireInWay, PrepToWaitOnDoor, GetShocked, AnthraxPoisoning, CanHelpOthers;
...
state ImOnFire
{
	ignores InterestIsAnnoyingUs, GetHitByDeadThing, BodyJuiceSquirtedOnMe, GettingDousedInGas, HearWhoAttackedMe, 
		...
		QPointSaysMoveUpInLine, CanHelpOthers, RocketIsAfterMe;
