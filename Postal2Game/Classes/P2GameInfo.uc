...
defaultproperties
	...
	ChameleonClass=class'Chameleon'
	ChamelHeadClass=class'ChamelHead'

	GameDifficulty=5.0
	FireDetail=8
	SmokeDetail=8
	BloodSpouts=true
	DynamicWeaponLights=0
	SplatDetail=5
	...
	ShadowDetail=0
	GeneralFogEnd=8000
	GeneralFogStart=1000
	SniperFogEnd=8000
	SniperFogStart=1000
	SliderPawnGoal=15
	GameRefVal=10	 // make same as START_GAME_REF
	BodiesSliderMax=25
	bShowTracers=true

	MatSwaps[0]=(OrigMat=Texture'Josh-textures.game_banner_2',NewMat=Texture'Josh-textures.game_banner_5')
	MatSwaps[1]=(OrigMat=Texture'Timb.Game_FagHunter',NewMat=Texture'Timb.Game_BastardFish')
	}
