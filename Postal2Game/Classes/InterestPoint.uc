...
{
	// always interested for the moment
	return true;
...
/*		case IDT_RunTo:
		...
		case IDT_Smoke:
			...
			{
				// We'll look towards the interest as specified and laugh
				log("I'MMMMMMMMM SMOKING............ GIVE ME AN ANIMATION AND STATE!");
				Personc.Focus = MyInterest;
				Personc.InterestPawn = None;
				Personc.Attacker = None;
				SetupPersonReturnState(Personc);
		...
		case IDT_KeyboardType:
			...
			break;
		default:
			log("ERROR: InterestPoint Action type not implemented");
	}
}
...
defaultproperties
{
     Texture=Texture'P2Misc.Icons.S_Interestpoint'
	 bStatic=False
     bCollideActors=True
     bCollideWorld=False
     bBlockActors=False
