...
var int						SkinRefCounts[500];		// Reference counts (skin's unique number is used as index)
...
function LogUsage()
	...
	Log("");
	Log("Body Type");
	Log("  Average.............."$int(TotalPeople) - CurrentBalance.OverallFat);
...
defaultproperties
	...
	DesiredBalance=(Gender=(Females=50,Males=50),RacialFemale=(Blacks=10,Mexicans=15,Whites=75),RacialMale=(Blacks=10,Mexicans=15,Whites=75),OverallMaleGay=3,OverallFemaleFem=10,OverallFat=5)
	}
