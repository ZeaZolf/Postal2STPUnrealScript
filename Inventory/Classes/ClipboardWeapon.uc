...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
state DownWeaponRemove extends EmptyDownWeapon
{
...
defaultproperties
	...
	bAllowHints=true
	bShowHints=true
	HudHint1="Press Fire (Left Mouse Button) to"
	HudHint2="bother someone to sign petition. "
	HudHint3="Keep asking if they say no!"

	DropWeaponHint1="They've seen your weapon!"
	DropWeaponHint2="Press ; to drop it."
	}
