...
//	Skins[0]=Texture'WeaponSkins.Dude_Hands'
	...
	bAllowHints=true
	bShowHints=true
	HudHint1="Press Fire(Left Mouse Button) for light-weight rocket."
	HudHint2="Press Secondary Fire(Right Mouse Button) for a bouncing heavy rocket."
	}
