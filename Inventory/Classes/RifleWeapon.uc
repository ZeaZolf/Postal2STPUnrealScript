...
const MAX_ZOOM_FOV		=	20;
const START_ZOOM_FOV	=	10;
...
simulated event RenderOverlays( canvas Canvas )
{
	...
	else	// draw in our fancy sniping reticle
	{
		...
		Scale = Canvas.ClipX/EXPECTED_START_RES_WIDTH_RIFLE;
		...
		// upper left
		Canvas.SetPos(0, 0);
		Canvas.DrawTile(SniperReticleCorner, Canvas.SizeX/2,
											Canvas.SizeY/2,
											0,
											0,
											-ULength, 
		...
		Canvas.SetPos(Scale*10, Scale*10);


		Canvas.DrawTile(SniperReticleCenter, Canvas.SizeX,
											Canvas.SizeY,
											0,
											0,
											ULength, 
...
//	Skins[0]=Texture'WeaponSkins.Dude_Hands'
	...
	SniperReticleCorner = Texture'P2Misc.Reticle.Rifle_Sight_Corner'
	SniperReticleCenter  = Texture'P2Misc.Reticle.Rifle_Sight_Crosshairs'
	BlackBackground=Texture'nathans.Inventory.BlackBox64'

	HudHint1="Secondary Fire(Right Mouse Button) brings up scope."
	HudHint2="Use Mouse Wheel to zoom in and out."
	bAllowHints=true
	bShowHints=true
	bShowHint1=true
	}
