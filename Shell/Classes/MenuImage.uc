...
function Created()
	...
	if (texImage != None)
		{
		ImageArea = UWindowBitmap(CreateWindow(
			class'UWindowBitmap',  
			ImageLeftEdge, 
			ImageTopEdge, 
		...
		ImageArea.bStretch = true;	// This value can be overridden by the extender.
	...
	SetButtonLocations(WinWidth, WinHeight);
	}
...
// size of the image.
///////////////////////////////////////////////////////////////////////////////
function SetButtonLocations(float W, float H)
	{
	local int iIter;
