...
enum EWeaponHoldStyle
	...
	WEAPONHOLDSTYLE_Both,						// single-handed in both hands (ex: two pistols)
...
native final function int PlayMusicAttenuate( string Song, float FadeInTime, optional float Volume, optional float Radius, optional float Pitch);
// RWS CHANGE: Attenuate music as this actor moves around (just like sounds)
